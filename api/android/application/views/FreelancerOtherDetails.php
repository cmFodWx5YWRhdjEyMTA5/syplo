                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Registred</strong> Freelancer Other Details</h3>
                                        ...
                                        foreach($userlist as $list) { 
                                            ...
                                            <tr>
                                                ...
                                                <td style="color:red; font-weight:bold;"><?php foreach ($rankData as $rank => $r ) {
                                                 ...
                                                 <td><a href="<?php echo site_url('admin/Freelancer/workimages?id='.$list->id); ?>">Work Image</a></td>
                                                 <td><a href="<?php echo site_url('admin/Freelancer/certificateimages?id='.$list->id); ?>">Certificate Image</a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
