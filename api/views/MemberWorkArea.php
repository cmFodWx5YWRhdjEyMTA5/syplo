                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Work Area</strong></h3>
                                    ...
                                    <div style="overflow:scroll; height:600px;">
                                     <table id="customers2" class="table datatable">
                                        ...
                                        foreach($address as $list) { ?>
                                            <tr>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo $list->area_address;?></td>
                                                <td><?php echo $list->area_lat;?></td>
                                                <td><?php echo $list->area_lng; ?></td>
                                                <td><?php if($list->address_status==1){
                                                 echo "Remote Address";} else {echo "Fixed";} ?></td>
