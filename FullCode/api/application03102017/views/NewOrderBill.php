		...
		?>
			...
			<table id="items">
                <tbody>
			  		...
			  		<tr>
					  <th style="font-weight: bolder;">Typ av behandlare</td>	
				      <td><?php echo $details['user_type'];?></td>
				      <th style="font-weight: bolder;">Företagnamn</td>	
				      <td style="font-weight: bolder;color:green"><?php echo $details['company_name'];?></td>
				  	</tr>
			  		<tr>
		...
		<table id="items">
		  <tbody>
			  ...
			  <tr>
			      ...
			      <td colspan="2"><?php echo 'kr '.$key->price; ?></td>
