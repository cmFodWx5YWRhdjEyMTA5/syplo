                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update</strong> Member Record</h3>
                            ...
                            <!-- erro display end here -->
                                ...
                                <form action="<?php echo site_url('admin/Company/update_member?id='.$userlist->id);?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="dob" class="form-control datepicker" value="<?php echo $userlist->dob;?>"/>
                                            </div>                                            
