                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Another</strong> Service</h3>
                                     ...
                                     <table id="customers2" class="table datatable">
                                        ...
                                        foreach($another_service as $list) { ?>
                                            <tr class="text-center">
												...
												<td><?php if($list->pricetype == '0') {  echo 'Per hour' ; } else { echo 'Fixed' ; }?></td>
                                                <!---td>
                                                    <a href="<php echo site_url('admin/Service/update_another_service/?id='.$list->id);?>">
                                                    <i class="fa fa-pencil fa-fw"><strong>Edit</strong>
                                                    </i></a>
                                                    </td---->
                                                    <td>
                                                     <a href="<?php echo site_url('admin/Service/delete_another_service/?id='.$list->id);?>">
