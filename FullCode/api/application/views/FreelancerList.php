            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Registered</strong> Freelancer</h3>
                            ...
                            { $status ='Approve Here';}
                             ?>
                                <tr>
                                    ...
                                    <td>
                                      <input class="btn btn-success" type="button" id="status<?php echo $list->id; ?>" onclick="approve(<?php echo $list->id; ?>)" name="status" value="<?php echo $status;?>">
                                    </td>              
                                    <?php } else {?>
                                        <td style="font-weight:bold;">Incomplete Registration</td>
                                        <?php }?>
                                    ...
                                    <!--td><!?php if($list->approve_status == '0') { echo 'Not approved'; } else { echo 'Approved' ;}?></td-->
                                    <!--<td><!?php echo $list->zipcode;?></td-->                    
                                    <td><?php echo "<img src=".base_url()."upload/".$list->user_image." width='60px' height='60px'>";?></td>
                                    <td><?php echo $list->created_at;?></td>
                                   
                                    <td>
                                        <a href="<?php echo site_url('admin/Freelancer/update_Freelancer?id='.$list->id);?>">
                                        <i class="fa fa-pencil fa-fw"><strong>Edit</strong>
                                        </i></a>
                                        </td>
                                        <td>
                                         <a href="<?php echo site_url('admin/Freelancer/delete?id='.$list->id);?>">
