                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?php echo site_url('admin/Admin/logout');?>" class="btn btn-success btn-lg">Yes</a>
...
<!-- <script>
 $(document).ready(function(){
    $("#tag").keyup(function(){ 
        $("#tag").autocomplete({
        source:"http://localhost/codeignator/medicalapp/index.php/PrescriptionControler/search_company/?"
        });
    });
        $("#medicine").autocomplete({
        source:"http://localhost/codeignator/medicalapp/index.php/PrescriptionControler/search_medicine/?"
        });
